  ...
  const submitHandler = async (e) => {
    ...
    if (password !== confirmPassword) {
      ...
      try {
        ...
        console.log(err);
        toast.error(err?.data?.message || err?.error || "Registration failed"); // FIXED
      }
    }
  };

  return (
    <div className="pl-[10rem] flex pr-[3rem]">
      ...
      <img
        ...
        alt="Register"
        className="hidden xl:block h-[65vh] w-[50%] object-cover rounded-lg mt-[5rem]"
      />
    </div>
  );
};
